...
console.log('\n🐱 留白正在进行双端差异化 siteConfig.ts 扫描与自我修复...');

// =================================================================
// 🌟 第一部分：双端共用的全量配置防线 (Common Configs)
// =================================================================
const commonConfigs = [
  { key: 'title', snippet: `\n  // 1. 网站标题与博主信息\n  title: "threetwoa の 七码处",` },
  { key: 'faviconUrl', snippet: `\n  faviconUrl: "https://bu.dusays.com/2026/03/24/69c1e38ac1846.jpg",` },
  { key: 'authorName', snippet: `\n  authorName: "threetwoa",` },
  { key: 'bio', snippet: `\n  bio: "我是 threetwoa，大二软件学生，个人开发者。白天在 IDE 里跟 Bug 搏斗，晚上在 Markdown 里跟灵感私奔。欢迎来到七码处——我的数字花园，目前只种了代码和一些不成器的诗。",` },
...
const tasks = [
  ...
  {
    name: '[前端]',
    filePath: path.resolve('./frontend/siteConfig.ts'),
    // 前端需要：仅仅是共用配置
